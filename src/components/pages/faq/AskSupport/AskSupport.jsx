...
const AskSupport = () => {
  return (
    <div className="comp-ask-sup">
      <div className="seg-ask-sup">
        <div className="elem-ask-sup">
          <h4 className="ask-sup-ttl">
            Don&apos;t find your answer. Ask for support.
          </h4>
          <p className="ask-sup-lead">
